...
using Project_WebApi.Controllers;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddDbContext<Entity>(options => {
                options.UseSqlServer("Data Source=.;Initial Catalog=E-Commerce_WebApi;Integrated Security=True");
            });


            services.AddIdentity<ApplicationUser, IdentityRole>().AddEntityFrameworkStores<Entity>();
